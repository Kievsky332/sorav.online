...
const projects = [
    ...
    {
        name: "Cutl",
        description: "твой псевдо сократитель ссылок. На самом деле это скрытый муу вирус. <br><br>⚠️ Не рекомендуется людям с эпилепсией и светочувствительностью — на сайте резкое мигание цветов.",
